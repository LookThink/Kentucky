...
namespace :chaser do
  ...
  task :install, [:sass_path] do |t, args|
    ...
    FileUtils.mkdir_p("#{Rails.root}/#{args.sass_path}/chaser")
    FileUtils.cp_r("#{source_root}/app/assets/stylesheets/.", "#{Rails.root}/#{args.sass_path}/chaser", { :preserve => true })
    Find.find("#{Rails.root}/#{args.sass_path}/chaser") do |path|
